 ...
 *
 */
//https://login.uab.pt/auth/v1/module.php/casserver/cas.php/login/?debugMode=samlValidate&service=http://localhost/
$config = [
    'authsource' => 'UAb-multi',
    ...
    'attrname' => 'sAMAccountName', // 'eduPersonPrincipalName',
