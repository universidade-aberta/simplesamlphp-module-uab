...
$config = [
     ...
     */
    'technicalcontact_name' => 'UAb - SI',
    'technicalcontact_email' => 'dsi@uab.pt',
    ...
    */
     ...
     */
    'auth.adminpassword' => '$2y$10$gjUoXd4QED5XDVez9Q9IHOc2O0k1riTp19LRt3ExqYm.9N4a4sXBu',
     ...
     */
    'enable.http_post' => true, // @TODO: remove this
    ...
    'logging.format' => "%level %stat[%trackid] %msg",
    ...
    //'session.cookie.domain' => '.login.uab.pt',
     ...
     */
    'memcache_store.prefix' => 'UAb_auth_',
     ...
     * is shown.
     */
    'frontpage.redirect' => 'https://localhost/module.php/uab/hello',
    //'frontpage.redirect' => 'https://login.uab.pt/auth/v1/module.php/uab/hello',
